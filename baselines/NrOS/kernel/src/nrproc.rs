...
impl<P: Process> NrProcess<P> {
    pub(crate) fn load(
        ...
        // log::info!("This is in load111 in kernel/src/nrproc.rs");        
        ...
        // log::info!("This is in load222 in kernel/src/nrproc.rs");        
    ...
    pub(crate) fn map_frame_id(
        ...
        debug_assert!(pid < MAX_PROCESSES, "Invalid PID");
        // log::info!("This is map_frame_id in kernel/src/nrproc.rs");
    ...
    pub(crate) fn map_frames(
        ...
        log::info!("This is map_frames in kernel/src/nrproc.rs, frames: {:?}", frames);
    ...
    fn dispatch_mut(&mut self, op: Self::WriteOperation) -> Self::Response {
        match op {
            ...
            ProcessOpMut::MemMapFrame(base, frame, action) => {
                ...
                // log::info!("This is MemMapFrame in kernel/src/nrproc.rs");
            ...
            ProcessOpMut::MemMapFrameId(base, frame_id, action) => {
                log::info!("This is ProcessOpMut::MemMapFrameId in kernel/src/nrproc.rs");
            ...
            ProcessOpMut::MemUnmap(vaddr) => {
                // log::info!("This is MemUnmap in kernel/src/nrproc.rs");
