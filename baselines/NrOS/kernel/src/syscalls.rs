    ...
    VSpaceDispatch<W> + FsDispatch<W> + SystemDispatch<W> + ProcessDispatch<W> + TestDispatch<W>
{
    ...
    fn process(&self, arg1: W, arg2: W, arg3: W) -> KResult<(W, W)> {
        ...
        // log::info!("This is process in kernel/src/syscalls.rs");
        // let validated = ProcessOperationArgs::validate(arg1, arg2, arg3);
            
        // match validated {
        //     core::prelude::v1::Ok(Poa::RequestCore(_core_id, _entry_point)) => {
        //         log::info!("This is process with RequestCore in kernel/src/syscalls.rs");
        //     },
        //     core::prelude::v1::Ok(Poa::ReleaseCore(_core_id)) => {
        //         log::info!("This is process with ReleaseCore in kernel/src/syscalls.rs");
        //     },
        //     _ => {
        //     }
        // }
    ...
    fn vspace(&self, arg1: W, arg2: W, arg3: W) -> KResult<(W, W)> {
        // log::info!("This is vspace in kernel/src/syscalls.rs");
