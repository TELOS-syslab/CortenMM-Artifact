...
impl fmt::Debug for Thread {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        write!(f, "Thread#{}, affinity: {}, joinlist: {:?}", self.id.0, self.affinity, self.joinlist)
    }
}
...
impl Thread {
    ...
    {
        // info!("00000000000000000000000000000");
        ...
        let generator = Generator::unsafe_new(stack, move |yielder, _| {
            ...
            // info!("[core {}]: At the start of the func", affinity);
            // rump lwp switchproc stuff here
            let r = f(arg);
            // info!("[core {}]: At the end of the func", affinity);
            // info!("2222222222222222222222222222");
