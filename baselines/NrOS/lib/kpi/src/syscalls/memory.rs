...
impl VSpace {
    ...
    pub unsafe fn map(base: u64, bound: u64) -> Result<(VAddr, PAddr), SystemCallError> {
        info!("This is map in lib/kpi/src/syscalls/memory.rs");
    ...
    pub unsafe fn map_frame(
        ...
        info!("This is map_frame in lib/kpi/src/syscalls/memory.rs");
    ...
    unsafe fn vspace(
        ...
        info!("This is vspace in lib/kpi/src/syscalls/memory.rs");
...
impl PhysicalMemory {
    ...
    fn allocate_frame(is_base: bool) -> Result<(FrameId, PAddr), SystemCallError> {
        info!("This is allocate_frame in lib/kpi/src/syscalls/memory.rs");
